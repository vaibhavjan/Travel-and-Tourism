...
<head>
  ...
  <title>Travel Mania | Flight Booking</title>
...
<body>
  ...
  <div class="main">
    <div class="container">
      <h1>BOOK A FLIGHT</h1>
      <form class="" action="searchflight.php" method="post">
        <div>
        ...
        <br>
        <div>
          <input type="submit" class="button" name="search_flight">
        </div>
      </form>
    </div>
    <div class="image">
      <img src="images/plane.jpg" alt="" width=400rem
