...
<form action="delete_hotel_action.php" method="POST" autocomplete="off">
    <fieldset>
      <h2 style="font-family:Impact">DELETE HOTEL</h2>
      <br>
     
      <input type="text" name="hotel" maxlenght="30" placeholder="HotelName"><br><br>
