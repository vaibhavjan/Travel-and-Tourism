...
if(isset($_POST['search_bus']))
{
    ...
    $sql="SELECT * FROM bus WHERE origin='{$row1['place_name']}' AND destination='{$row2['place_name']}'";
...
?>
 <table cellpadding="7px">
            ...
            <tr>
                ...
                <td>
                    <a href='bus_payment.php?id=<?php echo $row['bus_id']?>'>Book</a>
                </td>
            </tr>
            <?php }
            ?>
