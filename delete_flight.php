...
<form action="delete_flight_action.php" method="POST" autocomplete="off">
    <fieldset>
      <h2 style="font-family:Impact">DELETE FLIGHT</h2>
      <br>
     
      <input type="text" name="flight_id" maxlenght="30" placeholder="FlightNo"><br><br>
      <!-- <input type="text" name="operator" placeholder="Operator Full Name"><br><br>
      <input type="text" name="type" placeholder="Type of Bus"><br><br>
      ...
      <input type="number" name="available_seats" placeholder="Available Seats"><br><br>
