...
<form action="delete_bus_action.php" method="POST" autocomplete="off">
    <fieldset>
      <h2 style="font-family:Impact">DELETE BUS</h2>
      <br>
     
      <input type="text" name="bus_id" maxlenght="30" placeholder="BusNo"><br><br>
