...
<form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
      ...
      <h2 style="font-family:Impact">EDIT BUS</h2>
      <br>
     
      <input type="text" name="bus_id" maxlenght="30" placeholder=" Enter BusNo"><br><br>
...
?>
<form action="edit_bus_action.php" method="POST" autocomplete = "off">
      <h2 style="font-family:Impact; text-align:left">CHANGE BUS DETAILS</h2>
      <input type="hidden" name="bus_id" maxlenght="30" value="<?php echo $row['bus_id'] ?>">
      <br>
      ...
      <p>Departure Time
      <input type="time" name="departure_time" value="<?php echo $row['departure_time'] ?>">&nbsp;
      Arrival Time
      <input type="time" name="arrival_time" value="<?php echo $row['arrival_time'] ?>"></p><br>    
